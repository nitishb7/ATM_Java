...
public class driver {
        ...
        do {
            ...
            switch (ans) {
                ...
                case "1":
                    ...
                    String []bb =atm.transaction(fname, lname, dob, address, pin_1, mobileNumber, email);
                ...
                case "5":
                    ...
                    System.out.print("\n===================\nTo update your information, verify your account first. \n===================\n");
                    System.out.print("Please insert your card number>");
                    updateInfo(b, atm, input, "checking");
                    break;
    ...
    static void transaction(boolean b, ATM atm, Scanner input, long amount, String type, String acc_type, int option) throws IOException, ParseException {
        ...
        if(b && type=="print") {
            ...
            if(b && type=="withdraw") {
                System.out.println("\nTransaction successfully completed, take your cash!");
            }
    ...
    static void updateInfo(boolean b, ATM atm, Scanner input, String acc_type) throws IOException, ParseException {

        String pinCardNumber[] = PasswordField.readPinCardNumber("Enter your card pin:", input);
        b =atm.identifies(Integer.parseInt(pinCardNumber[0]),Long.parseLong(pinCardNumber[1]), acc_type);

        if (b == true) {
            System.out.println("Your Have an verified Account. Please update your information now.");
            System.out.println("Leave the fields blank if you don't want to update that field.");
            System.out.print("Enter your first name:");
            String fname= input.nextLine();
            System.out.print("Enter your last name:");
            String lname= input.nextLine();
            ...
            b =atm.updateInfo(fname, lname, dob, mobileNumber, email, address);
            if (b) {
