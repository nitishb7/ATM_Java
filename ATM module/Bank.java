...
public class Bank {
	...
	public String[] manages(String fname, String lname, String dob, String address, int pin_1, String mobNum, String email) throws IOException, ParseException {
		checking.setAccount(fname,lname,dob,address,pin_1,mobNum,email);
	return checking.getAccount();
	}

	public boolean manages(String fname, String lname, String dob, String mobNum, String email, String addr) throws IOException, ParseException {
		checking.updateAccount(fname, lname, dob, mobNum, email, addr);
		return true;
	}
